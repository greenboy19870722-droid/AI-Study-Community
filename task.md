...
| 2.2.5 实现【发布帖子】API接口 | ✅ 完成 | internal/controller/post/post.go, internal/cmd/cmd.go, go.mod | tuhome-backend-architect | 2026-04-10 20:43 | 6ba1cf9e | POST /api/post/create，修复cmd.go导入和go.mod模块名 |
